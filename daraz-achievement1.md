...
&emsp;&emsp;和当地同学再次远程连线，查看了几个旧 dada 平台的页面，坐实了这个可怕的想法，但我仍然不敢相信，Daraz 拥有上百万的用户，居然没有在本地部署 CDN 服务器，最近的CDN服务器远在新加坡，每个请求都跋山涉水横跨多个国家的从巴基斯坦跑到新加坡，再带着请求到的信息从新加坡跑回来
